...
const increaseDiv = document.getElementById('increase-option')
const decreaseDiv = document.getElementById('decrease-option')
const destroyDiv = document.getElementById('destroy-option')
const maxFireDiv = document.getElementById('max-option')
...
// Listeners
increaseDiv.addEventListener('click', () => increaseFireSource())
decreaseDiv.addEventListener('click', () => decreaseFireSource())
destroyDiv.addEventListener('click', () => destroyFireSource())
maxFireDiv.addEventListener('click', () => maxFireSource())
